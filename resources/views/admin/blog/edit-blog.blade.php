            ...
            <div class="well">
                ...
                <form name="editBlogForm" class="form-horizontal" action="{{ url('/blog/update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea1 name="blog_short_description" class="form-control" style="resize: vertical;">{{ $blogById->blog_short_description }}</textarea1>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-3">Blog Description</label>
                        <div class="col-sm-9">
                            <textarea1 name="blog_description" class="form-control" style="resize: vertical;">{{ $blogById->blog_description }}</textarea1>
